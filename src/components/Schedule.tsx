const schedule = [
  {
    ...
    label: 'Segunda-Feira',
    classes: [
      { time: '07:00', name: 'BJJ Adultos', duration: '1h' },
      { time: '12:00', name: 'BJJ Adultos', duration: '1h' },
      { time: '19:00', name: 'Kids', duration: '1h' },
      { time: '20:00', name: 'BJJ Adultos', duration: '1h30' },
    ],
  },
  {
    day: 'TER',
  ...
  },
  {
    ...
    label: 'Sábado',
    classes: [
      { time: '09:00', name: 'Kids', duration: '1h' },
...
const classStyle: Record<string, string> = {
  'BJJ Adultos': 'text-white-belt',
  Kids: 'text-gold',
  'Defesa Pessoal': 'text-mid-gray',
  'Open Mat': 'text-mid-gray/70',
};
    ...
    <section id="horarios" className="py-24 md:py-40 bg-blackout">
      <div className="px-6 max-w-5xl mx-auto">
        ...
        <div className="flex items-center gap-6 mb-8 flex-wrap">
          {[
            { color: 'text-white-belt', label: 'BJJ Adultos' },
            { color: 'text-gold', label: 'Kids' },
            { color: 'text-mid-gray', label: 'Defesa Pessoal / Open Mat' },
          ].map((item) => (
        ...
        <div className="flex flex-col gap-px">
          {schedule.map((day) => (
            <div key={day.day}>
              <div className="flex items-center gap-4 px-0 py-3 border-b border-white/5">
        ...
        <p className="font-mono text-[9px] tracking-[0.2em] text-mid-gray/30 uppercase mt-10 text-center">
          * Horários sujeitos a alteração — confirme conosco
        </p>
      </div>
    </section>
  );
